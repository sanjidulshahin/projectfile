...
ALTER TABLE co_t
ADD COLUMN registrationId  INT(11),
ADD CONSTRAINT co_t_FK FOREIGN KEY(registrationID) REFERENCES registration_t(registrationID);

UPDATE `co_t` SET `registrationId` = '1' WHERE `co_t`.`coID` = 7;

UPDATE `co_t` SET `registrationId` = '2' WHERE `co_t`.`coID` = 49;
UPDATE `co_t` SET `registrationId` = '3' WHERE `co_t`.`coID` = 50;
UPDATE `co_t` SET `registrationId` = '4' WHERE `co_t`.`coID` = 51;
UPDATE `co_t` SET `registrationId` = '5' WHERE `co_t`.`coID` = 52;
UPDATE `co_t` SET `registrationId` = '6' WHERE `co_t`.`coID` = 53;
UPDATE `co_t` SET `registrationId` = '7' WHERE `co_t`.`coID` = 54;
UPDATE `co_t` SET `registrationId` = '8' WHERE `co_t`.`coID` = 55;
UPDATE `co_t` SET `registrationId` = '9' WHERE `co_t`.`coID` = 56;
UPDATE `co_t` SET `registrationId` = '10' WHERE `co_t`.`coID` = 57;
UPDATE `co_t` SET `registrationId` = '11' WHERE `co_t`.`coID` = 58;
UPDATE `co_t` SET `registrationId` = '12' WHERE `co_t`.`coID` = 59;
UPDATE `co_t` SET `registrationId` = '13' WHERE `co_t`.`coID` = 60;
UPDATE `co_t` SET `registrationId` = '14' WHERE `co_t`.`coID` = 61;
UPDATE `co_t` SET `registrationId` = '15' WHERE `co_t`.`coID` = 62;
UPDATE `co_t` SET `registrationId` = '16' WHERE `co_t`.`coID` = 63;
UPDATE `co_t` SET `registrationId` = '17' WHERE `co_t`.`coID` = 64;
UPDATE `co_t` SET `registrationId` = '18' WHERE `co_t`.`coID` = 65;
UPDATE `co_t` SET `registrationId` = '19' WHERE `co_t`.`coID` = 66;
UPDATE `co_t` SET `registrationId` = '20' WHERE `co_t`.`coID` = 67;
UPDATE `co_t` SET `registrationId` = '21' WHERE `co_t`.`coID` = 68;
UPDATE `co_t` SET `registrationId` = '22' WHERE `co_t`.`coID` = 69;
UPDATE `co_t` SET `registrationId` = '23' WHERE `co_t`.`coID` = 70;
UPDATE `co_t` SET `registrationId` = '24' WHERE `co_t`.`coID` = 71;
UPDATE `co_t` SET `registrationId` = '25' WHERE `co_t`.`coID` = 72;

CREATE TABLE clo_cal_t(
    coID INT(11) NOT NULL,
    sectionID INT(11) NOT NULL,
    studentID INT(11) NOT NULL,
    clo1 INT (4) NOT NULL,
    ...
    clo3 INT (4) NOT NULL,
    clo4 INT (5) NOT NULL,
    CONSTRAINT clo_cal_PK PRIMARY KEY (coID,sectionID,studentID),
    CONSTRAINT clo_cal_FK1 FOREIGN KEY (coID) REFERENCES co_t (coID),
    CONSTRAINT clo_cal_FK2 FOREIGN KEY (sectionID) REFERENCES section_t(sectionID),
    CONSTRAINT clo_cal_FK3 FOREIGN KEY (studentID) REFERENCES student_t(studentID)
    )
